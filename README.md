...
FlowLedger 是一个手机优先的个人财务 Web App，将日常流水、账户余额、多币种资产、Crypto 持仓、预算和固定账单放在同一本账中。其中的功能主要参考了Percento和鲨鱼记账，在使用这两款软件的过程中认为均有不便，无法完整的体现自己的财务状况，遂vibe coding出了这个web app。
